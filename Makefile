...
ODIR = obj
LOC = src/
OBJS	 = obj/main.o obj/GameGenerics.o obj/Tetris.o obj/Arkanoid.o obj/Snake.o obj/MineSweeper.o
SOURCE	 = src/*.cpp
HEADER	 = *.h
OUT	 = GameBoy
CC	 = g++
...
obj/MineSweeper.o: $(LOC)MineSweeper.cpp
	$(CC) $(FLAGS) $(LOC)MineSweeper.cpp -std=c++11 -o obj/MineSweeper.o
